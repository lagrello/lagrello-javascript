...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LagrelloApi.UpdateUserRequest();
  });
  ...
  describe('UpdateUserRequest', function() {
    it('should create an instance of UpdateUserRequest', function() {
      ...
      //var instane = new LagrelloApi.UpdateUserRequest();
      //expect(instance).to.be.a(LagrelloApi.UpdateUserRequest);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new LagrelloApi.UpdateUserRequest();
