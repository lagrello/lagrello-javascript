...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LagrelloApi.CreateTokenRequest();
  });
  ...
  describe('CreateTokenRequest', function() {
    it('should create an instance of CreateTokenRequest', function() {
      ...
      //var instane = new LagrelloApi.CreateTokenRequest();
      //expect(instance).to.be.a(LagrelloApi.CreateTokenRequest);
    });
    ...
    it('should have the property tokenName (base name: "tokenName")', function() {
      ...
      //var instance = new LagrelloApi.CreateTokenRequest();
